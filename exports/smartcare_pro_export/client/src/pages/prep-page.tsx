...
import { PrepDataSummary } from "@/components/patient/prep-data-summary";
...
import { PastMedicalHistoryDialog } from "@/components/medical-record/past-medical-history-dialog"; // Added import
...
export default function PrepPage() {
  ...
  const [pastMedicalHistoryOpen, setPastMedicalHistoryOpen] = useState(false); // Added state
    ...
    <div className="min-h-screen bg-[#f5f5f5]">
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                <input 
                  ...
                  className="h-9 rounded-md px-8 py-2 bg-[#e6f7ff] border-none text-sm text-black w-64 focus:outline-none focus:ring-2 focus:ring-blue-400"
                />
                <div className="absolute left-2 top-1/2 transform -translate-y-1/2">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7.33333 12.6667C10.2789 12.6667 12.6667 10.2789 12.6667 7.33333C12.6667 4.38781 10.2789 2 7.33333 2C4.38781 2 2 4.38781 2 7.33333C2 10.2789 4.38781 12.6667 7.33333 12.6667Z" stroke="#0072BC" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M14 14L11.1333 11.1333" stroke="#0072BC" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
              </div>
              ...
              <div className="text-right">
                <span className="block font-medium">Masempela Rural Health Centre</span>
              </div>
      ...
      <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-4">
          <h2 className="text-red-500 font-medium">Training Portal</h2>
          <h1 className="text-xl font-bold mt-2 mb-4">Create New PrEP</h1>
        </div>
