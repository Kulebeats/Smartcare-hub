...
import { ANCAssessmentCard } from "@/components/medical-record/anc-assessment-card";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="min-h-screen bg-white relative pt-16">
        ...
        <div className="max-w-7xl mx-auto px-4 py-6 relative z-10">
          ...
          {/* ANC Assessment Card - Added to Client Profile Section */}
          <div className="max-w-7xl mx-auto px-4 pb-6 relative z-10">
            <ANCAssessmentCard 
              patientId={patientData.nupn || "demo-patient"}
              isExpanded={false}
            />
          </div>
