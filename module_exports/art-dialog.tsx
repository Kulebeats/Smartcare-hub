  ...
  return (
    <Dialog open={open} onOpenChange={(isOpen) => !isOpen && onClose()}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Antiretroviral Therapy (ART)</DialogTitle>
        </DialogHeader>
          ...
          <form onSubmit={form.handleSubmit(onSave)}>
            <Tabs value={selectedTab} onValueChange={setSelectedTab} className="w-full">
              <div className="flex flex-col">
                ...
                <TabsContent value="enrollment" className="space-y-4 max-h-[60vh] overflow-y-auto">
                  <Card>
                    <CardContent className="pt-6">
                      <h3 className="text-lg font-semibold mb-4">ART Enrollment</h3>
                ...
                <TabsContent value="clinical" className="space-y-4 max-h-[60vh] overflow-y-auto">
                  <Card>
                    <CardContent className="pt-6">
                ...
                <TabsContent value="labs" className="space-y-4 max-h-[60vh] overflow-y-auto">
                  <Card>
                    <CardContent className="pt-6">
                ...
                <TabsContent value="treatment" className="space-y-4 max-h-[60vh] overflow-y-auto">
                  <Card>
                    <CardContent className="pt-6">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              >
                                <SelectTrigger>
                                  <SelectValue placeholder="Select ARV" />
                                </SelectTrigger>
                                <SelectContent>
                                  {ART_REGIMENS.map((regimen) => (
                                    <SelectItem key={regimen} value={regimen}>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>Quantity Dispensed (tablets)</FormLabel>
                              <Input 
                                type="number" 
                                {...field} 
                                onChange={(e) => {
                          ...
                          render={({ field }) => (
                            <FormItem className="flex flex-row items-start space-x-3 space-y-0 mt-4">
                              <Checkbox 
                                ...
                                id="adherenceCounseling"
                              />
                              <div className="space-y-1 leading-none">
                                <FormLabel htmlFor="adherenceCounseling">
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                              ...
                              />
                              <div className="space-y-1 leading-none">
                                <FormLabel htmlFor="nutritionalSupport">
                                  Nutritional Support
                                </FormLabel>
                              </div>
                            </FormItem>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                              ...
                              />
                              <div className="space-y-1 leading-none">
                                <FormLabel htmlFor="psychosocialSupport">
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                              ...
                              />
                              <div className="space-y-1 leading-none">
                                <FormLabel htmlFor="communityLinkage">
                                  Community Linkage
                                </FormLabel>
                              </div>
                            </FormItem>
